...
class raw_data_validation:
    ...
    def __init__(self, path):
        ...
        self.schema_path = 'Schema Files/schema_training.json'
    ...
    def values_from_schema(self):
        """
            ...
            Associated log file : "Training_Logs/valuesfromSchemaValidationLog.txt"
        ...
        """
        log_file = "Training_Logs/valuesfromSchemaValidationLog.txt"
    ...
    def validate_file_name_raw(self, regex):
        ...
        Associated log file :"Training_Logs/nameValidationLog.txt"
        Written By: richabudhraja8@gmail.com
        Version: 1.0
        Revisions: None
        ...
        self.file_op_obj.deleteExistingBadDataTrainingFolder()
        self.file_op_obj.deleteExistingGoodDataTrainingFolder()
        # create new directories
        self.file_op_obj.createDirectoryForGoodBadRawData()
        log_file = "Training_Logs/nameValidationLog.txt"
    ...
    def validate_column_length(self, noofcolumns):
        ...
        Output: None
        Associated log file : "Training_Logs/columnValidationLog.txt"
        On Failure: Exception
    ...
    """
        log_file = "Training_Logs/columnValidationLog.txt"
        try:
            file_obj = open(log_file, 'a+')
            self.log_writer.log(file_obj, "Column Length Validation Started!!")
            all_files = os.listdir(self.good_data_loc)
    ...
    def validate_whole_column_isnull(self):
        ...
        Output: None
        Associated log file :"Training_Logs/missingValuesInColumn.txt"
        On Failure: Exception
        ...
        Revisions: None
        """
        log_file = "Training_Logs/missingValuesInColumn.txt"
        try:
            file_obj = open(log_file, 'a+')
            ...
            for file in all_files:
                ...
                for columns in csv:
                    if (len(csv[columns]) != csv[columns].count()):
                        ...
                        shutil.move(file_loc, self.bad_data_loc)
                        self.log_writer.log(file_obj,
                                            "Invalid Column for the file!! File moved to Bad Raw Folder :: %s" % file)
                        break
